  ...
  return( <div className='bg-primary/60 h-full '>
    ...
    <div className='w-full h-screen   bg-gradient-to-r from-primary/10 via-black/30 to-black/10 '>
      <div className='text-center flex flex-col justify-center xl:pt-40  xl:text-left h-full container mx-auto'>
        ...
        Hello, I'm Erfan Mizban
Computer Engineering student at Ferdowsi University of Mashhad | Full-Stack Developer | Founder of NORD GROUP

I'm passionate about building innovative solutions through code, with professional experience in both frontend and backend development. As the founder of NORD GROUP, I lead a team of student developers working on impactful projects.

I'm always open to interesting collaborations and new opportunities. Let's connect and explore how we can work together!
