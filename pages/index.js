...
Im always open to interesting collaborations and new opportunities. Lets connect and explore how we can work together!
    ...
    <div className='w-full h-full absolute right-0 bottom-0 '>
      ...
      <ParticlesContainer />
      <motion.div variants={fadeIn('up' , 0.5)} initial='hidden' animate='show' exit='hidden' transition={{duration:1 , ease : 'easeInOut'}} className='w-full h-full max-w-[475px] max-h-[395px] absolute bottom-0 right-[15%] '>
        <Avatar />
      </motion.div>
    </div>
  </div>
