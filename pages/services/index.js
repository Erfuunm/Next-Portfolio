    ...
    <div className=' container mx-auto'>
      <div className='flex flex-col xl:flex-row gap-x-8'>
        <div className=' text-center flex xl:w-[30vw] flex-col lg:text-left mb-4 -mt-10 xl:mb-0 xl:mt-0'>
          ...
          className='mb-4 max-w-[400px] mx-auto lg:mx-0'>Here is some of the Services wich you can expect me to do for your self. for the item wich doesnt exist in this list contact me .</motion.p>
        </div>
